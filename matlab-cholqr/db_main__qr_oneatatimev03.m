...
%   
   ...
   dGG(1:n,1:n) = dGG(1:n,1:n) - dV(1:n,1:n)' * dV(1:n,1:n);                 
%
...
%  norm ( ( dG(2:n,2:n) + dA(1:n,2:n)' * dA(1:n,2:n) - dV(1:n,2:n)' * dV(1:n,2:n) ) - ( V2(n+1:m,2:n)' * V2(n+1:m,2:n) ), 'fro' ) / norm( (V2(2:m,2:n)'*V2(2:m,2:n) ), 'fro' )
   ...
   norm ( dGG(2:n,2:n) - G(2:n,2:n) , 'fro' ) / norm( G(2:n,2:n), 'fro' )
%
%  step 2.1
%
%  dnorma = norm( [ V2(2:m,2) ],2);                                                               % 2.1
%  dnorma = sqrt( [ V2(2:m,2)]'*[V2(2:m,2) ] );                                                   % 2.1
%  dnorma = sqrt( V2(2:n,2)'*V2(2:n,2) + [ V2(n+1:m,2)]'*[V2(n+1:m,2) ] );                        % 2.1
%  dnorma = sqrt( dV(2:n,2)'*dV(2:n,2) + [ V2(n+1:m,2)]'*[V2(n+1:m,2) ] );                        % 2.1
%
% CHANGED to GG
%   dnorma = sqrt( dV(2:n,2)'*dV(2:n,2) + dG(2,2) );                                               % 2.1
   dnorma = sqrt( dV(2:n,2)'*dV(2:n,2) + dGG(2,2) );                                               % 2.1
%
...
%   dtau(2) = 2/( 1 + dV(3:n,2)'*dV(3:n,2) + ( dG(2,2) ) / dalpha(2)^2 );
   dtau(2) = 2/( 1 + dV(3:n,2)'*dV(3:n,2) + ( dGG(2,2) ) / dalpha(2)^2 );
%
...
%
%   dV(2:n,3:n) = dV(2:n,3:n) - [ 1; dV(3:n,2) ] * dtau(2) * ( dV(2,3:n) + ( dG(2,3:n) / dalpha(2) + dV(3:n,2)' * dV(3:n,3:n) )  );      % 2.7
   dV(2:n,3:n) = dV(2:n,3:n) - [ 1; dV(3:n,2) ] * dtau(2) * ( dV(2,3:n) + ( dGG(2,3:n) / dalpha(2) + dV(3:n,2)' * dV(3:n,3:n) )  );      % 2.7
%
%  this is the check
...
%  this is what we would do working on a V
   ...
   GG1(3:n,3:n) = V(3:m,3:n)'*V(3:m,3:n); 
...
%  step 3.0
%  
%   dG(3:n,3:n) = dG(3:n,3:n) + dA(1:n,3:n)' * dA(1:n,3:n) - dV(2:n,3:n)' * dV(2:n,3:n) ;                     % 3.0
%   dG(3:n,3:n) = dG(3:n,3:n) + dA(1:n,3:n)' * dA(1:n,3:n) - dV(2:n,3:n)' * dV(2:n,3:n) ;                     % 3.0
%   dG(3:n,3:n) = dG(3:n,3:n) + ss - dd ;            % 2.0
%   dG(k:n,k:n) = dG(k:n,k:n) + dA(1:n,k:n)' * dA(1:n,k:n) - dV(1:n,k:n)' * dV(1:n,k:n) ;                     % 3.0
%
%    dG(3:n,3:n) = dG(3:n,3:n) + dA(1:n,3:n)' * dA(1:n,3:n) - dV(2:n,3:n)' * dV(2:n,3:n) ;                     % 3.0
    dGG(1:n,1:n) = dGG(1:n,1:n) - dV(1:n,1:n)' * dV(1:n,1:n);
    dGGG(1:n,1:n) = dGG(1:n,1:n) - dV(1:n,1:n)' * dV(1:n,1:n)
%    dGG(2:n,2:n) = dGG(2:n,2:n) - dV(2:n,2:n)' * dV(2:n,2:n) 
