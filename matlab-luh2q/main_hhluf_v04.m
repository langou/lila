...
%
   m = 60;
   tb = [ 3, 3, 3, 3, 3, 5, 7, 9, 5, 4, 5 ];
%  tb = [ 4, 3, 5, 12, 9, 6, 8, 7, 5, 4, 5 ];
   nb = [ 20, 13 ];
   for nb2 = 1:20,
   nb = [ 20, nb2 ];
%  for i = 1:sum(tb),
...
%
   [ A ] = lila_ormqrf_v04( m, nb(2), k, i, A, 1, 1, lda, A, 1, ilo(2), lda, T, 1, 1, ldt, tb );
%
   mll = mll-k;
%
   iblo = iblo+k;
...
%
   i = i_2;
   k = k_2;
   if ( i+k-1>nb(1) ) fprintf('i+k-1>nb(1)\n'); break; end
   fprintf('i=%2d   k=%2d    ',i,k);
%
