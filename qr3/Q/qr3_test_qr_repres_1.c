...
int qr3_test_qr_repres_1( double *norm_repres, int m, int n, double *A, int lda, double *Q, int ldq, double *R, int ldr ){

	double normA, *work;
	int info, lwork, jj, ii;
	...
	cblas_dtrmm( CblasColMajor, CblasRight, CblasUpper, CblasNoTrans, CblasNonUnit, m, n, (1.0e+00), R, ldr, Q, ldq );
	printf("\n%f   ",Q[0]);
	printf("\n%f   ",work[0]);
	printf("%f\n",A[0]);
