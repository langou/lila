...
int dgeqr3_left( int m, int n, double *A, int lda, double *T, int ldt ){

	// The usual dgeqr3 but calls itself, than the 
	// one that does not construct T12
	...
	/* from Q1^TA2 to Q2 */
	dgeqr3_left( m-n1, n2, &(A[n1*lda+n1]), lda, &(T[n1+n1*ldt]), ldt );
