...
int qr3_dorgqr_UT( int m, int n, double *Q, int ldq, double *T, int ldt, double *tau ){
...
//		if ( m > 1 ) cblas_dscal( m-1, -(*tau), Q+1, 1);
		...
		qr3_dorgqr_UT( m-n1, n2, Q22, ldq, T22, ldt, tau2 );
		...
		qr3_dorgqr_UT( m, n1, Q11, ldq, T11, ldt, tau1 );
