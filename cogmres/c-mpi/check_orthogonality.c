...
double check_orthogonality(int mloc, int n, double *Q, int lda, MPI_Comm mpi_comm){
	...
	cblas_dsyrk( CblasColMajor, CblasUpper, CblasTrans, n, mloc, 1.0e+00, Q, mloc, 0e+00, temp_buf, n); 
	...
	if (my_rank==0) orthlevel = lapack_dlansy( 'F', 'U', n, temp_buf, n, NULL );
