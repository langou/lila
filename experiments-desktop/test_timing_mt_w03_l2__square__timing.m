   clear
   close all
   X = load('test_timing_w03_l2__square__1thread.dat');
   m = X(:,2);
   perf = X(:,6);
   Y = load('test_timing_w03_l2__square__2threads.dat');
   m = Y(:,2);
   perf = Y(:,6);
   T = load('test_timing_w03_l2__square__3threads.dat');
   m = T(:,2);
   perf = T(:,6);
   Z = load('test_timing_w03_l2__square__4threads.dat');
   m = Z(:,2);
   perf = Z(:,6);
