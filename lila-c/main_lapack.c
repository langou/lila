...
int main(int argc, char ** argv) {
	...
	work = (double *) malloc( (n+ii) * (n+ii) * sizeof(double));
	lwork = (n+ii)*(n+ii);
...
//	printf("2 \n");
	...
	if( m == n+ii ) lila_dormqrf_z02( m, n, n-1, ii, 0, n, A, lda, T, ldt, RR, m, work, lwork );
	if ( m > n+ii ) lila_dormqrf_z02( m, n,   n, ii, 0, n, A, lda, T, ldt, RR, m, work, lwork );
	free( work );
//	printf("3 \n");
