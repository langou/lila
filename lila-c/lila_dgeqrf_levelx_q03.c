...
int lila_dgeqrf_levelx_q03( int panel, int leaf, int n_lvl, int i_lvl, int *nb_lvl, int m, int n, int i, int mt, double *A, int lda, double *T, int ldt, double *Q, int ldq, double *work, int lwork ){
...
//			info = lila_dgeqrf_q03_mt_hr( panel, m, vb, i, mt, A, lda, T, ldt, Q, ldq, work, lwork );
		...
		info = lila_dgeqrf_levelx_q03( panel, leaf, n_lvl, i_lvl+1, nb_lvl, m, vb, j, mt, A, lda, T, ldt, Q, ldq, work, lwork );
	}
...
//			info = lila_dgeqrf_q03_mt_hr( panel, m, vb, j, mt, A, lda, T, ldt, Q, ldq, work, lwork );
		}
