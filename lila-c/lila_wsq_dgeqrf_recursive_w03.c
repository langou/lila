...
int lila_dgeqrf_recursive_w03( int panel, int leaf, int m, int n, int i, int mt, double *A, int lda, double *T, int ldt, double *Q, int ldq, double *work, int lwork ){
	...
	if ( n < 2 ) {
		...
		info = lila_dgeqrf_recursive_w03( panel, leaf, m, nb1, i, mt, A, lda, T, ldt, Q, ldq, work, lwork );
		info = lila_dormqrf_w03( m, nb2, nb1, i, i+nb1, mt, A, lda, T, ldt, work, lwork );
		info = lila_dgeqrf_recursive_w03( panel, leaf, m, nb2, i+nb1, mt, A, lda, T, ldt, Q, ldq, work, lwork );
