...
// cheating /////////
//	info = LAPACKE_dlacpy_work( LAPACK_COL_MAJOR, 'U', n+i, n+i, A, lda, AAs, lda ); 
...
//	info = LAPACKE_dlacpy_work( LAPACK_COL_MAJOR, 'U', n+i, n+i, AAs, lda, A, lda ); 
