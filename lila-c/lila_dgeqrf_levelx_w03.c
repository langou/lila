...
int lila_dgeqrf_levelx_w03( int panel, int leaf, int n_lvl, int i_lvl, int *nb_lvl, int m, int n, int i, int mt, double *A, int lda, double *T, int ldt, double *Q, int ldq, double *work, int lwork ){
	...
	if( i_lvl == n_lvl-1 ){
		...
		if ( leaf == 0 ){
			info = lila_dgeqrf_w03_mt_l ( panel, m, vb, i, mt, A, lda, T, ldt, Q, ldq, work, lwork );
		} 
		else if ( leaf == 1 ){
		...
		info = lila_dgeqrf_levelx_w03( panel, leaf, n_lvl, i_lvl+1, nb_lvl, m, vb, j, mt, A, lda, T, ldt, Q, ldq, work, lwork );
	}
	...
	if( i_lvl == n_lvl-1 ){
		...
		if ( leaf == 0 ){
			info = lila_dgeqrf_w03_mt_l ( panel, m, vb, j, mt, A, lda, T, ldt, Q, ldq, work, lwork );
		} 
		else if ( leaf == 1 ){
