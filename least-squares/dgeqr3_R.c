...
int dgeqr3_R( int m, int n, double *A, int lda, double *T, int ldt, double *R, int ldr ){
	...
	dgeqr3_R( m, n1, A11, lda, T11, ldt, R11, ldr );
	...
	dgeqr3_R( m-n1, n2, A22, lda, T22, ldt, R22, ldr );
